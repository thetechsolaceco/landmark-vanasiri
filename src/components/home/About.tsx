        ...
        <div className="about-block">
          <div className="about-block-top">
            <div className="about-block-title-wrap">
              ...
              >
                We create architectural farmland plots designed for modern
                countryside living.
              </h2>
            </div>
          ...
          <div className="about-block-bottom">
            ...
            <div className="about-paragraphs-wrapper">
              ...
              >
                <p>
                  Offering architectural farmland plots for sale near
                  Bengaluru, built through thoughtful design, honest guidance
                  and a lasting commitment to countryside living in Hosakote.
                  Your family deserves a farmland retreat that&apos;s built to
                  last, planned with care, precision and a deep respect for
                  the land.
                </p>
              </div>
              <div
              ...
              >
                <p>
                  Landmark Vanasiri is developed by Landmark Nest, a
                  Bengaluru based real estate developer with a focus on eco
                  conscious, nature integrated design across residential and
                  farmland projects in Bengaluru Rural District. Landmark
                  Nest&apos;s approach centers on building with minimal
                  disruption to the natural landscape, a principle carried
                  through in Landmark Vanasiri&apos;s farmland layout.
                </p>
              </div>
            </div>
          </div>
